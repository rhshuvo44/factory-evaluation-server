...
FactoryDevelopmentSchema.pre<TFactoryDevelopment>('save', async function (next) {
    if (this.date) {
...
export const FactoryDevelopment = model<TFactoryDevelopment>('FactoryDevelopment', FactoryDevelopmentSchema)
