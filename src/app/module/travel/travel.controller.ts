...
const createTravellingAllowance = catchAsync(async (req: Request, res: Response) => {
    const TravellingAllowance = await TravelService.createTravelAllowance(req?.body)
...
const getAllTravellingAllowance = catchAsync(async (req: Request, res: Response) => {
